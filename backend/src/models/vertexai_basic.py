"""VertexAI API to generate a basic conversational chatbot.

Chatbot based on Google's PaLM 2 without providing any additional
...
class VertexAIBasic(ChatBot):
    ...
    def _llm(self):
        ...
        max_tokens = self.config.get("vertexai", {}).get("max_tokens", "256")
