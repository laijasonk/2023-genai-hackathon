...
"""
    ...
    def _prompt(self):
        ...
        style = f"Write a short two sentence style guide containing fashion advice for a customer interested in buying {info['outerwear1']}, {info['top1']}, and {info['bottom1']}."
        collection1 = f"Write a short two sentence product description for a collection containing {info['outerwear1']}, {info['top1']}, and {info['bottom1']}."
        collection2 = f"Write a short two sentence product description for a collection containing {info['outerwear2']}, {info['top2']}, and {info['bottom2']}."
        collection3 = f"Write a short two sentence product description for a collection containing {info['outerwear3']}, {info['top3']}, and {info['bottom3']}."
